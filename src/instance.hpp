...
public:
    ...
    vector<Remorque*>* getRemorques();
    vector<Station*>* getStations();

    // Nombre totale de site (stations + remorques)
    int get_nb_sites() {
        // return Site::nb_sites(); // FAUX SI PLUSIEURS INSTANCES SIMULTANEES !
    ...
    // Quelques méthodes de recherche d'objet à partir de nom.
