...
//
// hist (complément)
// - 27/10/2016 (diam) : le type INTEGER peut commencer par les caractère - ou +
//              (pour pouvoir passer un entier négatif e.g. : --intermax -1)
...
class OptionParser {
    ...
    OptionParser* test(int argc, char *argv[]) {
        ...
        // VOIR les fichiers main.cpp et DemoOptions.hpp
        ...
        // Ce qui suit est la seule utilisation de opt pour le compilateur gcc
        ...
        cout << "Recherche existence d'une option de clé \"--mydouble\"";
